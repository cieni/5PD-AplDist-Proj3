...
begin
  ...
  begin
    ...
    begin
      ...
      while not Eof do
      begin
        vExcel.Range['B3'].Value := FieldByName('codigoCurso').AsString + ' - ' + pegarNomeBD('DCurso', FieldByName('codigoCurso').AsString);
        ...
        vExcel.Range['AG4'].Value := pegarNomeBD('DProfessor', FieldByName('codigoProfessor').AsString);
